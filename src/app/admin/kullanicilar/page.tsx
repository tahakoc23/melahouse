...
import { Users, Search, Mail, Phone, MapPin, ShoppingBag, ShieldCheck, RefreshCw, X, Eye, Calendar, UserCheck } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 text-xs font-inter max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-4">
        <div>
          <h1 className="text-2xl font-bold font-playfair text-[#1A1A1A]">Kayıtlı Kullanıcılar & Müşteriler</h1>
          <p className="text-gray-500 text-[11px] mt-0.5">Sisteme kayıtlı tüm kullanıcıları, iletişim bilgilerini, adreslerini ve sipariş geçmişlerini inceleyin.</p>
        </div>
            ...
            <table className="w-full text-xs text-left">
              <thead className="text-[10px] text-gray-400 uppercase bg-gray-50 border-b border-gray-200 font-semibold tracking-wider">
                <tr>
                  ...
                  <th className="px-4 py-3.5">Sipariş Sayısı</th>
                  <th className="px-4 py-3.5">Toplam Harcama</th>
                    ...
                    <tr key={user.id} className="hover:bg-gray-50/60 transition-colors">
                      ...
                      <td className="px-4 py-3.5 text-right">
                        <button
                          ...
                          className="px-3 py-1.5 bg-gray-100 hover:bg-[#1A1A1A] hover:text-white text-gray-800 font-semibold rounded-xs transition-colors inline-flex items-center gap-1.5 cursor-pointer text-[11px]"
                        >
                          <Eye size={13} />
                          <span>Detaylar</span>
                        </button>
